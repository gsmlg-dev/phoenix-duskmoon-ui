defmodule DuskmoonStorybookWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DuskmoonStorybookWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DuskmoonStorybookWeb.Gettext, "errors", msg, opts)
    end
  end
