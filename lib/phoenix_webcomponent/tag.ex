defmodule Phoenix.WebComponent.Tag do
  @moduledoc ~S"""
  Helpers related to producing HTML tags within templates.

  > Note: the examples in this module use `safe_to_string/1`
  > imported from `Phoenix.WebComponent` for readability.
  ...
  import Phoenix.WebComponent, except: [attributes_escape: 1]
  ...
  See `Phoenix.WebComponent.Tag.tag/2` for more information and examples.
  ...
  @doc false
  defdelegate attributes_escape(attrs), to: Phoenix.WebComponent
