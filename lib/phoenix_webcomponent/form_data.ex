defprotocol Phoenix.WebComponent.FormData do
  @moduledoc """
  Converts a data structure into a [`Phoenix.WebComponent.Form`](`t:Phoenix.WebComponent.Form.t/0`) struct.
  """
  ...
  """
  @spec to_form(t, Keyword.t()) :: Phoenix.WebComponent.Form.t()
  def to_form(data, options)

  @doc """
  Converts the field in the given form based on the data structure
  into a list of [`Phoenix.WebComponent.Form`](`t:Phoenix.WebComponent.Form.t/0`) structs.
  ...
  custom field removed.
  """
  @spec to_form(t, Phoenix.WebComponent.Form.t(), Phoenix.WebComponent.Form.field(), Keyword.t()) ::
          [Phoenix.WebComponent.Form.t()]
  def to_form(data, form, field, options)

  @doc """
  Returns the value for the given field.
  """
  @spec input_value(t, Phoenix.WebComponent.Form.t(), Phoenix.WebComponent.Form.field()) :: term
...
defimpl Phoenix.WebComponent.FormData, for: [Plug.Conn, Atom] do
